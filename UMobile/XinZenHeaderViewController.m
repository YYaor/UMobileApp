...
@interface XinZenHeaderViewController ()

@end

@implementation XinZenHeaderViewController
...
-(void)CleanData{
    ...
    if ([self.setting intForKey:@"ISBS"] == 1){
        [self.allInfo removeObjectsForKeys:@[@"4",@"5",@"6",@"7",@"8",@"9",@"10",@"11"]];
    }else{
        [self.allInfo removeObjectsForKeys:@[@"3",@"4",@"5",@"6",@"7",@"8",@"9",@"10"]];
    }
}
*/
-(void)CleanData{
