...
@interface SPGLViewController ()

@end

@implementation SPGLViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    if (self.bSelect){
        ...
        NSArray *rs =  [self.result objectAtIndex:indexPath.row];
        ShangPinDtlViewController *vc =  (ShangPinDtlViewController *)[self.storyboard instantiateViewControllerWithIdentifier:@"ShangPinDtlViewController"];
