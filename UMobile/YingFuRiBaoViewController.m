...
#import "YingFuRiBaoViewController.h"

@interface YingFuRiBaoViewController ()

@end

@implementation YingFuRiBaoViewController
...
-(void)loadData{
    NSString *link = [self GetLinkWithFunction:26 andParam:[NSString stringWithFormat:@"10,'%@',1",[self GetCurrentDate]]];// [NSString stringWithFormat:@"%@?UID=119&Call=26&Param=5,'',1",MainUrl];
    
    __block YingFuRiBaoViewController *tempSelf = self;
    ...
    [self StartQuery:link completeBlock:^(id obj) {
        ...
        tempSelf.columnView.numYIntervals = 4;
