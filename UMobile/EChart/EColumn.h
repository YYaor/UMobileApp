...
@property (nonatomic,retain) CAShapeLayer * chartLine;

@property (nonatomic, retain) UIColor * barColor;

@property (nonatomic, retain) EColumnDataModel *eColumnDataModel;

-(void)rollBack;

@property (assign, nonatomic) id <EColumnDelegate> delegate;
@end
