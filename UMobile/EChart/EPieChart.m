  ...
  ePieChartDataModel:(EPieChartDataModel *)ePieChartDataModel
{
    ...
    if (self)
    {
        ...
        UILabel *title = [[[UILabel alloc] initWithFrame:self.frame] autorelease];
        title.text = @"Dec";
        ...
        UIView *line = [[[UIView alloc] initWithFrame:self.bounds] autorelease];
        ...
        UICountingLabel *budgetLabel = [[[UICountingLabel alloc] initWithFrame:self.frame] autorelease];
        ...
        UICountingLabel *currentLabel = [[[UICountingLabel alloc] initWithFrame:self.frame] autorelease];
        ...
        UICountingLabel *estimateLabel = [[[UICountingLabel alloc] initWithFrame:self.frame] autorelease];
