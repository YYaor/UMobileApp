...
@property (nonatomic, retain) UIColor *minColumnColor;
@property (nonatomic, retain) UIColor *maxColumnColor;
@property (nonatomic, retain) UIColor *normalColumnColor;
...
@property (assign, nonatomic) id <EColumnChartDataSource> dataSource;
@property (assign, nonatomic) id <EColumnChartDelegate> delegate;
@end
