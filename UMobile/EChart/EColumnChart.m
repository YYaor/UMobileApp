...
@property (retain, nonatomic) NSMutableDictionary *eColumns;
@property (retain, nonatomic) NSMutableDictionary *eLabels;
@property (retain, nonatomic) EColumn *fingerIsInThisEColumn;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        self.eLabels = [NSMutableDictionary dictionary];
        self.eColumns = [NSMutableDictionary dictionary];
...
- (void)reloadData
{
    ...
    for (int i = 0; i < totalColumnsRequired; i++)
    {
        ...
        if (eColumnDataModel == nil)
            eColumnDataModel = [[[EColumnDataModel alloc] init] autorelease];
    ...
    {
        UIView *bottomLine = [[[UIView alloc] initWithFrame:CGRectMake(0, self.frame.size.height, 0, BOTTOM_LINE_HEIGHT)] autorelease];
...
-(void)dealloc{
    self.minColumnColor = nil;
    self.maxColumnColor = nil;
    self.normalColumnColor = nil;
