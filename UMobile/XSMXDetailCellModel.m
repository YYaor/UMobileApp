...
//    model.typeString = [dataArray objectAtIndex:0];
//    model.numberString = [dataArray objectAtIndex:1];
//    
//    model.typeString = [dataArray objectAtIndex:2];
//    model.companyString = [dataArray objectAtIndex:3];
//    model.storeString = [dataArray objectAtIndex:4];
//    model.itemNameString = [dataArray objectAtIndex:5];
//    model.itemAmountString = [dataArray objectAtIndex:6];
//    model.largnessAmountString = [dataArray objectAtIndex:7];
//    model.moneyString = [dataArray objectAtIndex:8];
//    model.costMoneyString = [dataArray objectAtIndex:9];
//    model.profitMoneyString = [dataArray objectAtIndex:10];
    //--testData
